    ...
    inline void memory_create(mem_handle & handle, vcl_size_t size_in_bytes, viennacl::context const & ctx, const void * host_ptr = NULL)
    {
      if (size_in_bytes > 0)
      {
        ...
        switch(handle.get_active_handle_id())
        {
          ...
          default:
            throw memory_exception("unknown memory handle (memory_create)!");
        }
      }
    }
      ...
      if (bytes_to_copy > 0)
      {
        switch(src_buffer.get_active_handle_id())
        {
          ...
          case MEMORY_NOT_INITIALIZED:
            throw memory_exception("not initialised!");
          default:
            throw memory_exception("unknown memory handle (memory_copy)!");
        }
      }
    }
                                    ...
                                    mem_handle & dst_buffer)
    {
      ...
      switch(src_buffer.get_active_handle_id())
      {
        ...
        case MEMORY_NOT_INITIALIZED:
          throw memory_exception("not initialised!");
        default:
          throw memory_exception("unknown memory handle (memory_shallow_copy)!");
      }
    }
      ...
      if (bytes_to_write > 0)
      {
        switch(dst_buffer.get_active_handle_id())
        {
          ...
          case MEMORY_NOT_INITIALIZED:
            throw memory_exception("not initialised!");
          default:
            throw memory_exception("unknown memory handle (memory_write)!");
        }
      }
    }
      ...
      if (bytes_to_read > 0)
      {
        switch(src_buffer.get_active_handle_id())
        {
          ...
          case MEMORY_NOT_INITIALIZED:
            throw memory_exception("not initialised!");
          default:
            throw memory_exception("unknown memory handle (memory_read)!");
        }
      }
    }
